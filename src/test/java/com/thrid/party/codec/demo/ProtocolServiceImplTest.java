...
public class ProtocolServiceImplTest {
     ...
     * <p>
     * <pre>
     * 设备上报数据:AA 72 00 00 00 CC CC 00 00 0A 20 00 00 00 00
     * </pre>
     *
     * @throws Exception
     */
    ...
    private static byte[] initDeviceReqByte() {
         ...
         */
        byte[] byteDeviceReq = new byte[15];
        ...
        byteDeviceReq[5] = (byte) 0xCC;
        byteDeviceReq[6] = (byte) 0xCC;
        byteDeviceReq[7] = (byte) 0x00;
        byteDeviceReq[8] = (byte) 0x00;
        byteDeviceReq[9] = (byte) 0X0A;
        byteDeviceReq[10] = (byte) 0X20;
        byteDeviceReq[11] = (byte) 0x00;
        byteDeviceReq[12] = (byte) 0x00;
        byteDeviceReq[13] = (byte) 0x00;
        byteDeviceReq[14] = (byte) 0x00;
    ...
    private static ObjectNode initCloudReqObjectNode() {
        ...
        paras.put("value", "DDDD00000E010000000000000000");
